...
<head>
  ...
  <style>
    body {
  background: url(images/bg/image.jpg) #eeeeee;
      ...
      <div class="header_bottom">
        <div class="container-fluid">
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand " href="index.html"> EduRegistra </a>
              ...
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="team.jsp"> Team </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="emplogin.jsp">Student</a>
                            </li>
              </ul>
            </div>
          </nav>
  ...
  <footer class="footer_section">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">Team 6024</a>
      </p>
    </div>
  </footer>
  <!-- footer section -->
